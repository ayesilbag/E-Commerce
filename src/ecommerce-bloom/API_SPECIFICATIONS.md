# Bizdenalbizdensat E-Commerce API Specifications & Data Models
...
- **Base URL:** `https://api.bizdenalbizdensat.com/v1`
...
const API_BASE_URL =
  process.env.REACT_APP_API_BASE_URL || "https://api.bizdenalbizdensat.com/v1";
